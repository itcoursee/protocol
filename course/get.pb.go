...
type GetReq struct {
	...
	Fields []string `protobuf:"bytes,10,rep,name=fields,proto3" json:"fields,omitempty" validate:"dive,oneof=tags category.parents category.children direction covers"`
}
