...
func (c *rpcClient) Add(ctx context.Context, in *AddReq, opts ...grpc.CallOption) (*AddRsp, error) {
	out := new(AddRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.course.Rpc/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rpcClient) Get(ctx context.Context, in *GetReq, opts ...grpc.CallOption) (*GetRsp, error) {
	out := new(GetRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.course.Rpc/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rpcClient) Paging(ctx context.Context, in *PagingReq, opts ...grpc.CallOption) (*PagingRsp, error) {
	out := new(PagingRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.course.Rpc/Paging", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rpcClient) Update(ctx context.Context, in *UpdateReq, opts ...grpc.CallOption) (*UpdateRsp, error) {
	out := new(UpdateRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.course.Rpc/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rpcClient) Delete(ctx context.Context, in *DeleteReq, opts ...grpc.CallOption) (*DeleteRsp, error) {
	out := new(DeleteRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.course.Rpc/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Rpc_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.course.Rpc/Add",
	}
...
func _Rpc_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.course.Rpc/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Rpc_Paging_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.course.Rpc/Paging",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Rpc_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.course.Rpc/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Rpc_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.course.Rpc/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Rpc_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.itcoursee.protocol.course.Rpc",
	...
	Metadata: "com/itcoursee/protocol/course/rpc.proto",
}
