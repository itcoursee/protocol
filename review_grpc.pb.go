...
type ReviewClient interface {
	...
	// 自己
	Self(ctx context.Context, in *review.SelfReq, opts ...grpc.CallOption) (*review.SelfRsp, error)
	// 删除
...
func (c *reviewClient) Self(ctx context.Context, in *review.SelfReq, opts ...grpc.CallOption) (*review.SelfRsp, error) {
	out := new(review.SelfRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.Review/Self", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReviewServer interface {
	...
	// 自己
	Self(context.Context, *review.SelfReq) (*review.SelfRsp, error)
	// 删除
...
func (UnimplementedReviewServer) Self(context.Context, *review.SelfReq) (*review.SelfRsp, error) {
...
func _Review_Self_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(review.SelfReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServer).Self(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.Review/Self",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServer).Self(ctx, req.(*review.SelfReq))
	}
	return interceptor(ctx, in, info, handler)
}
