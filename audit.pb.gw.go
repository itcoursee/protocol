...
var (
	filter_Audit_GetsByReview_0 = &utilities.DoubleArray{Encoding: map[string]int{"review": 0}, Base: []int{1, 2, 0, 0}, Check: []int{0, 1, 2, 2}}
)
...
func request_Audit_GetsByReview_0(ctx context.Context, marshaler runtime.Marshaler, client AuditClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Audit_GetsByReview_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterAuditHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AuditServer) error {
	...
	mux.Handle("GET", pattern_Audit_GetsByReview_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/com.itcoursee.protocol.Audit/GetsByReview", runtime.WithHTTPPathPattern("/reviews/{review}/audits"))
		if err != nil {
		...
		forward_Audit_GetsByReview_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAuditHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuditClient) error {
	...
	mux.Handle("GET", pattern_Audit_GetsByReview_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/com.itcoursee.protocol.Audit/GetsByReview", runtime.WithHTTPPathPattern("/reviews/{review}/audits"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Audit_GetsByReview_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"reviews", "review", "audits"}, ""))
