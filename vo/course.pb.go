...
type Course struct {
	...
	DirectionId int64 `protobuf:"varint,13,opt,name=direction_id,json=directionId,proto3" json:"directionId,string,omitempty"`
	// 分类
	// @inject_tag: json:"categoryId,string,omitempty"
	CategoryId int64 `protobuf:"varint,14,opt,name=category_id,json=categoryId,proto3" json:"categoryId,string,omitempty"`
	// 阶段
	...
	OwnerId int64 `protobuf:"varint,16,opt,name=owner_id,json=ownerId,proto3" json:"ownerId,string,omitempty"`
	// 简介
