...
type Course struct {
	...
	DirectionId int64 `protobuf:"varint,70,opt,name=direction_id,json=directionId,proto3" json:"direction_id,omitempty"`
	// 分类
	// @inject_tag: json:"categoryId,string,omitempty"
	CategoryId int64 `protobuf:"varint,80,opt,name=category_id,json=categoryId,proto3" json:"category_id,omitempty"`
	// 阶段
	Stage int32 `protobuf:"varint,90,opt,name=stage,proto3" json:"stage,omitempty"`
	// 创建用户
	// @inject_tag: json:"ownerId,string,omitempty"
	OwnerId int64 `protobuf:"varint,100,opt,name=owner_id,json=ownerId,proto3" json:"owner_id,omitempty"`
	// 简介
