...
type Object struct {
	...
	Key string `protobuf:"bytes,10,opt,name=key,proto3" json:"key,omitempty" validate:"required"`
	// 上传后返回的ETag头信息
	// @inject_tag: validate:"required"
	Etag string `protobuf:"bytes,20,opt,name=etag,proto3" json:"etag,omitempty" validate:"required"`
	// 大小
	// @inject_tag: validate:"required"
	Size int64 `protobuf:"varint,30,opt,name=size,proto3" json:"size,omitempty" validate:"required"`
	// 分片编号
	// @inject_tag: validate:"required"
	Part int32 `protobuf:"varint,40,opt,name=part,proto3" json:"part,omitempty" validate:"required"`
	// 版本
