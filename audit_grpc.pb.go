...
const (
	Audit_GetsByReview_FullMethodName = "/com.itcoursee.protocol.Audit/GetsByReview"
...
type AuditClient interface {
	// 按审核获取
	GetsByReview(ctx context.Context, in *audit.GetsByReviewReq, opts ...grpc.CallOption) (*audit.GetsByReviewRsp, error)
	// 分页
...
func (c *auditClient) GetsByReview(ctx context.Context, in *audit.GetsByReviewReq, opts ...grpc.CallOption) (*audit.GetsByReviewRsp, error) {
	out := new(audit.GetsByReviewRsp)
	err := c.cc.Invoke(ctx, Audit_GetsByReview_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuditServer interface {
	// 按审核获取
	GetsByReview(context.Context, *audit.GetsByReviewReq) (*audit.GetsByReviewRsp, error)
	// 分页
...
func (UnimplementedAuditServer) GetsByReview(context.Context, *audit.GetsByReviewReq) (*audit.GetsByReviewRsp, error) {
...
func _Audit_GetsByReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Audit_GetsByReview_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuditServer).GetsByReview(ctx, req.(*audit.GetsByReviewReq))
	}
