...
type AuditClient interface {
	// 按审核获取
	GetsByReview(ctx context.Context, in *audit.PagingReq, opts ...grpc.CallOption) (*audit.PagingReq, error)
	// 分页
...
func (c *auditClient) GetsByReview(ctx context.Context, in *audit.PagingReq, opts ...grpc.CallOption) (*audit.PagingReq, error) {
	out := new(audit.PagingReq)
...
type AuditServer interface {
	// 按审核获取
	GetsByReview(context.Context, *audit.PagingReq) (*audit.PagingReq, error)
	// 分页
...
func (UnimplementedAuditServer) GetsByReview(context.Context, *audit.PagingReq) (*audit.PagingReq, error) {
...
func _Audit_GetsByReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuditServer).GetsByReview(ctx, req.(*audit.PagingReq))
	}
