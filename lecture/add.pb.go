...
type AddReq struct {
	...
	// 章节编号
	// @inject_tag: json:"chapterId,string"
	ChapterId int64 `protobuf:"varint,20,opt,name=chapter_id,json=chapterId,proto3" json:"chapterId,string"`
	// 类型
	// @inject_tag: validate:"required,oneof=10 20 30"
	Type int32 `protobuf:"varint,30,opt,name=type,proto3" json:"type,omitempty" validate:"required,oneof=10 20 30"`
	// 讲次名称
...
var file_itcoursee_protocol_lecture_add_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x01, 0x0a, 0x06, 0x41, 0x64, 0x64, 0x52,
	...
	,
...
var file_itcoursee_protocol_lecture_add_proto_depIdxs = []int32{
	2, // 0: itcoursee.protocol.lecture.AddRsp.lecture:type_name -> itcoursee.protocol.vo.Lecture
