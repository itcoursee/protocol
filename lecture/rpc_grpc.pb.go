...
type RpcClient interface {
	...
	// 视频关联
	Resource(ctx context.Context, in *ResourceReq, opts ...grpc.CallOption) (*ResourceRsp, error)
	// 删除
...
func (c *rpcClient) Add(ctx context.Context, in *AddReq, opts ...grpc.CallOption) (*AddRsp, error) {
	out := new(AddRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.lecture.Rpc/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rpcClient) Get(ctx context.Context, in *GetReq, opts ...grpc.CallOption) (*GetRsp, error) {
	out := new(GetRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.lecture.Rpc/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rpcClient) GetsByCourse(ctx context.Context, in *GetsByCourseReq, opts ...grpc.CallOption) (*GetsByCourseRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.lecture.Rpc/GetsByCourse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rpcClient) GetPlayback(ctx context.Context, in *GetPlaybackReq, opts ...grpc.CallOption) (*GetPlaybackRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.lecture.Rpc/GetPlayback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rpcClient) Update(ctx context.Context, in *UpdateReq, opts ...grpc.CallOption) (*UpdateRsp, error) {
	out := new(UpdateRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.lecture.Rpc/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rpcClient) Resource(ctx context.Context, in *ResourceReq, opts ...grpc.CallOption) (*ResourceRsp, error) {
	out := new(ResourceRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.lecture.Rpc/Resource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rpcClient) Delete(ctx context.Context, in *DeleteReq, opts ...grpc.CallOption) (*DeleteRsp, error) {
	out := new(DeleteRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.lecture.Rpc/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RpcServer interface {
	...
	// 视频关联
	Resource(context.Context, *ResourceReq) (*ResourceRsp, error)
	// 删除
...
func (UnimplementedRpcServer) Resource(context.Context, *ResourceReq) (*ResourceRsp, error) {
...
func _Rpc_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.lecture.Rpc/Add",
	}
...
func _Rpc_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.lecture.Rpc/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Rpc_GetsByCourse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.lecture.Rpc/GetsByCourse",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Rpc_GetPlayback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.lecture.Rpc/GetPlayback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Rpc_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.lecture.Rpc/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Rpc_Resource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResourceReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RpcServer).Resource(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.lecture.Rpc/Resource",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RpcServer).Resource(ctx, req.(*ResourceReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Rpc_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.lecture.Rpc/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Rpc_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.itcoursee.protocol.lecture.Rpc",
	...
	Metadata: "com/itcoursee/protocol/lecture/rpc.proto",
}
