...
func request_Rpc_Whole_0(ctx context.Context, marshaler runtime.Marshaler, client RpcClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SubcategoryReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.Whole(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Rpc_Whole_0(ctx context.Context, marshaler runtime.Marshaler, server RpcServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SubcategoryReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.Whole(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterRpcHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RpcServer) error {
	...
	mux.Handle("GET", pattern_Rpc_Whole_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/com.itcoursee.protocol.category.Rpc/Whole", runtime.WithHTTPPathPattern("/categories/{id}/subcategories"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Rpc_Whole_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Rpc_Whole_0(annotatedContext, mux, outboundMarshaler, w, req, response_Rpc_Whole_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterRpcHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RpcClient) error {
	...
	mux.Handle("GET", pattern_Rpc_Whole_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/com.itcoursee.protocol.category.Rpc/Whole", runtime.WithHTTPPathPattern("/categories/{id}/subcategories"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Rpc_Whole_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
type response_Rpc_Whole_0 struct {
	proto.Message
}

func (m response_Rpc_Whole_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*SubcategoryRsp)
...
var (
	...
	pattern_Rpc_Whole_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"categories", "id", "subcategories"}, ""))
...
var (
	...
	forward_Rpc_Whole_0 = runtime.ForwardResponseMessage
