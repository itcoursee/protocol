...
type RpcClient interface {
	...
	// 获取
	Whole(ctx context.Context, in *WholeReq, opts ...grpc.CallOption) (*WholeRsp, error)
	// 按父分类获取子分类列表
...
func (c *rpcClient) Whole(ctx context.Context, in *WholeReq, opts ...grpc.CallOption) (*WholeRsp, error) {
	out := new(WholeRsp)
...
type RpcServer interface {
	...
	// 获取
	Whole(context.Context, *WholeReq) (*WholeRsp, error)
	// 按父分类获取子分类列表
...
func (UnimplementedRpcServer) Whole(context.Context, *WholeReq) (*WholeRsp, error) {
...
func _Rpc_Whole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RpcServer).Whole(ctx, req.(*WholeReq))
	}
	return interceptor(ctx, in, info, handler)
}
