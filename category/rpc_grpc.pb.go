...
type RpcClient interface {
	...
	// 按父分类获取子分类列表
	Children(ctx context.Context, in *ChildrenReq, opts ...grpc.CallOption) (*ChildrenRsp, error)
	// 更新
...
func (c *rpcClient) Children(ctx context.Context, in *ChildrenReq, opts ...grpc.CallOption) (*ChildrenRsp, error) {
	out := new(ChildrenRsp)
	err := c.cc.Invoke(ctx, "/com.itcoursee.protocol.category.Rpc/Children", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RpcServer interface {
	...
	// 按父分类获取子分类列表
	Children(context.Context, *ChildrenReq) (*ChildrenRsp, error)
	// 更新
...
func (UnimplementedRpcServer) Children(context.Context, *ChildrenReq) (*ChildrenRsp, error) {
...
func _Rpc_Children_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChildrenReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RpcServer).Children(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.itcoursee.protocol.category.Rpc/Children",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RpcServer).Children(ctx, req.(*ChildrenReq))
	}
	return interceptor(ctx, in, info, handler)
}
